# ASCON Hardware
This repository contains accompanying HDL codes for the paper **Side-channel and Fault Attack Resistant ASCON Implementation: A Detailed Hardware Evaluation** 
